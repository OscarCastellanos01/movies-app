import { CastMovie, CompleteMovie, Movie } from "../interfaces/movie.interface";
import { Cast } from "../interfaces/moviedb-credits.response";
...
export class MovieMapper {
  ...
  static fromMovieDBCastToEntity = (actor: Cast): CastMovie => {
    return {
      id: actor.id,
      name: actor.name,
